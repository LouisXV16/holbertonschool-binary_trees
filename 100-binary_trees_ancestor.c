...
#include "10-binary_tree_depth.c" /* Include the function for calculating tree depth */
                                     ...
                                     const binary_tree_t *second)
{
    ...
    /* Adjust depth of deeper node's ancestor until both nodes are at the same depth */
